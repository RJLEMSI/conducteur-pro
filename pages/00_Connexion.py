"""
Page 00 â Connexion / Inscription
PremiÃ¨re page affichÃ©e. Authentification via Supabase Auth.
"""
import sys, os
...
st.set_page_config(
    page_title="Connexion Â· ConducteurPro",
    page_icon="ð",
    layout="wide",
...
# âââ Header de marque âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
st.markdown("""
...
# âââ Features rapides ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
st.markdown("""
<div class="features-grid">
    <div class="feature-item">
        <div class="icon">ð</div>
        <div class="label">MÃ©trÃ©s automatiques</div>
    </div>
    <div class="feature-item">
        <div class="icon">ð</div>
    ...
    <div class="feature-item">
        <div class="icon">ð</div>
        <div class="label">SynthÃ¨se DCE</div>
    </div>
    <div class="feature-item">
        <div class="icon">ð</div>
    ...
    <div class="feature-item">
        <div class="icon">ð¤</div>
        <div class="label">PropulsÃ© par l'IA</div>
    </div>
</div>
""", unsafe_allow_html=True)

# âââ Formulaire connexion / inscription ââââââââââââââââââââââââââââââââââââââ
tab_login, tab_register, tab_reset = st.tabs([
    "ð Se connecter",
    "ð CrÃ©er un compte",
    "ð Mot de passe oubliÃ©"
])
...
with tab_login:
    with st.form("login_form", clear_on_submit=False):
        ...
        password = st.text_input("Mot de passe", type="password", placeholder="â¢â¢â¢â¢â¢â¢â¢â¢", key="login_pwd")
...
with tab_register:
    with st.form("register_form", clear_on_submit=True):
        ...
        <div style="font-size:0.8rem;color:#6B7280;margin:0.5rem 0;">
            En crÃ©ant un compte, vous acceptez nos <a href="#" target="_blank">Conditions d'utilisation</a>
            et notre <a href="#" target="_blank">Politique de confidentialitÃ©</a>.
        </div>
        """, unsafe_allow_html=True)
        ...
        if submitted:
            if not reg_email or not reg_pwd:
                ...
                with st.spinner("CrÃ©ation du compte..."):
                    ...
                    if result["success"]:
                        st.success(result["message"])
                        st.info("ð§ VÃ©rifiez votre boÃ®te mail pour confirmer votre inscription, puis connectez-vous.")
                    else:
                        st.error(result["message"])
...
with tab_reset:
    with st.form("reset_form", clear_on_submit=True):
        ...
        st.markdown("Entrez votre email et nous vous enverrons un lien de rÃ©initialisation.")
...
<div style="text-align:center;color:#9CA3AF;font-size:0.8rem;">
    ConducteurPro v3.0 Â· PropulsÃ© par Claude AI Â· Â© 2025 ConducteurPro
</div>
""", unsafe_allow_html=True)
