...
with tab_general:
    ...
    if all_phases:
        ...
        st.infn("Aucune phase de chantier planifiee. Utilisez l'onglet **Calculer un Planning Chantier** pour commencer.")
...
with tab_chantier:
    ...
    chantier = chantier_selector(key="planning_calc_chantier")
    if not chantier:
        st.stop()
